 ...
 */
class SquareOscillatorBL : SawtoothOscillatorBL() {
    override fun generateBL(multiTable: MultiTable, currentPhase: Double, positivePhaseIncrement: Double, flevel: Double, i: Int): Double {
        ...
        var phase2 = currentPhase + 1.0 /* 180 degrees out of phase. */
        if (phase2 >= 1.0) {
            phase2 -= 2.0
        }
         ...
         * Nyquist/2.0!
         */
        val STARTAMP = 0.92 /* Derived by viewing waveforms with TJ_SEEOSC */
        val scale = STARTAMP - positivePhaseIncrement
